...
* [Enabling Compilation of Packages](https://breonh.github.io/CSSS508/docs/compiling.html)
...
### 4. Understanding R Data Structures
   ...
   * **Homework 4 (two options, complete one):**
       + **Homework 4: R Data Structures (Less Advanced)**
           ...
           * Homework 4: Data Structures, Key: 
       + **Homework 4: Linear Regression (More Advanced)**
           ...
           * Homework 4: Linear Regression, Key:     
...
### 5. Importing, Exporting, and Cleaning Data
   ...
   * **Homework 5, Part 1:**
       ...
       + [Homework 5: HTML Document](https://clanfear.github.io/CSSS508/Homework/HW5/homework_5.html)
           * Homework 5, Part 1: Key:
       + [2016 general election voting data for King County](https://raw.githubusercontent.com/clanfear/CSSS508/master/Homework/HW5/king_county_elections_2016.txt) (60 MB download; save, **DO NOT LOAD IN BROWSER**!)
