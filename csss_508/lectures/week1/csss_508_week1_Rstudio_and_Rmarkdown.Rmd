...
date: "September 29, 2021<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%b %d, %Y'))`"
output:
...
* Office Hours: 
   * Breon: Tuesdays, 0900-1100 via ZOOM link here 

Materials: http://breonh.github.io/CSSS508/index.html
...
* Follow the [grading rubric](https://breonh.github.io/CSSS508/docs/peer_review.html)
...
* PDFs of slides if you like that instead.
* Homework templates (HW 4+).
* Video recordings of the lectures and labs (troubleshooting the first couple weeks).
...
We are currently next door to CSSCR (rhymes with teaser)
