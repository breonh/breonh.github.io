...
In the instructions below, anywhere it says (version), there will be a series of numbers such as `4.1.1`. The specific version does not matter, but we want to always use the most recent one.
...
1. Go to the [Installers page](https://www.rstudio.com/products/rstudio/download/#download).
   * Click `Download RStudio for Windows` or, under All Installers, the link next to  `Windows 10` to download: Whatever version is listed will be the most current.
...
4. Open RStudio and verify it loads.
   ...
   * If there are any problems, email me at [breonh@uw.edu](mailto:breonh@uw.edu)
