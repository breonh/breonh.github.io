---
title: "Syllabus for CS&SS 508"
---

### [Introduction to R for Social Scientists](https://breonh.github.io/csss_508)
### Class Overview

Instructor: [Breon Haskett](mailto:breonh@uw.edu)
...
**Lab (Optional but highly recommended) - SAVERY 117**

 Tuesdays    3:30-5:20

**Breon's Office Hours - [ZOOM Link](https://washington.zoom.us/j/94740190466) **
...
in the future. We will cover almost no statistics, however it is the intention that this course will
...
### [Course Website](https://breonh.github.io/csss_508/)
[breonh.github.io/csss_508/](https://breonh.github.io/csss_508/)

The course website is accessible without a UWnetID and features lecture slides, R
...
#### [Mailing List](mailto:csss508a_sp22@uw.edu)

This course features a mailing list for asking questions. I encourage
you to use this list as your primary means of answering *long technical questions*. To use the mailing list, address your email to `csss508a_sp22@uw.edu`
and it will be sent to the instructor and all students in the class. Unless you specifically
request otherwise, emailed questions directed to me ([breonh@uw.edu](mailto:breonh@uw.edu)) that may be useful to others in the class will be answered with a response to the class mailing list. 

#### [Slack Channel](https://uwcsss508.slack.com/)

We will also use a Slack channel for collaborative communication.
...
### [Homework](https://breonh.github.io/csss_508/homework.html): 75% (3 points)
...
### [Peer Review](https://breonh.github.io/csss_508/peer_review.html): 25% (1 point)
