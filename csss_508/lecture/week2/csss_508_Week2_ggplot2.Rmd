...
date: "April 7, 2022<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%b %d, %Y'))`"
output:
...
`breonh.github.io/csss_508/lecture/week2/csss_508_week2_ggplot2.Rmd`
...
--
.smaller[
For journal articles I recommend Ben Marwick's [`rrtools`](https://github.com/benmarwick/rrtools) and [`huskydown`](https://github.com/benmarwick/huskydown) for UW dissertations and theses. [Chuck made an `rrtools` demo presentation here](https://clanfear.github.io/birthtiming/inst/presentation/presentation.html#/).
]
---
...
Read this as, "Take the `gapminder$pop` data and then get the `mean()`, and then send the output of that to `log()`."
Pipes read "left to right" while nested functions read "inside to out."
...
.center[
<img src="https://raw.githubusercontent.com/breonh/breonh.github.io/main/csss_508/lecture/week2/images/ggplot2unit.jpg" style="width: 60%;"/>
]
...
.footnote[[1] [Though this is not without debate](https://simplystatistics.org/posts/2016-02-11-why-i-dont-use-ggplot2/)]
...
* You can use other `geoms` like histograms, bar charts, add vertical or horizontal lines, etc. [You may find this data visualization cheat sheet helpful](https://raw.githubusercontent.com/rstudio/cheatsheets/master/data-visualization.pdf).
