...
date: "May 26, 2022<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%b %d, %Y'))`"
output:
...
Let's do this again, but for the entire state of Georgia.
...
pb_state %>% 
  ggplot(aes(fill=`Any Black`)) + 
  geom_sf(size = NA) + 
  geom_sf(data = urban_ga, color = "black", #<<
...
We add the `urban_ga` data as a new layer:
