...
If you're interested in advanced project management, ask me after class or check out [this presentation on reproducible research with rrtools]
...
.small[
```{r}
billboard_2000_raw <- read_csv(file = "https://breonh.github.io/csss_508/lectures/week5/data/billboard.csv")
```
]
...
billboard_2000_raw <- 
  read_csv(file = "https://breonh.github.io/csss_508/lectures/week5/data/billboard.csv",
           col_types = bb_types) #<<
```
