...
# files_for_apply <- paste0("open_data_year_one/", files_in_year_one)
# 
# lapply_data_list <- lapply(files_for_apply, read_csv)
...
data_list[["trip_data"]]  <- data_list[["trip_data"]] %>%
  mutate(across(c(starttime, stoptime), lubridate::mdy_hm))
